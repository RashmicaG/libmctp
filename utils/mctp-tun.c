...
int main(int argc, char * const *argv)
{
	...
	if (ctx->pcap.ast_binding.path) {
		...
		mctp_binding_set_capture_handler(mctp_binding_astlpc_core(ctx->astlpc), capture_binding,
	...
	if (ctx->pcap.raw_binding.path) {
		...
		mctp_binding_set_capture_handler(mctp_binding_raw_core(ctx->tun), capture_binding,
